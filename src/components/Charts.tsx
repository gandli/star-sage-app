        ...
        <AnimatePresence mode="wait">
            {isLoading ? (
                ...
                >
                    ...
                    <GlassCard
                        className="md:p-8 h-[380px] md:h-[450px] flex flex-col min-h-0 overflow-hidden"
                    >
                    ...
                    {/* 2. Star Trends (Area) */}
                    <GlassCard
                        className="md:p-8 h-[380px] md:h-[450px] flex flex-col hover:shadow-indigo-500/10 min-h-0 overflow-hidden"
                    >
                    ...
                    {/* 3. Ranking (Bar) */}
                    <GlassCard
                        className="md:p-8 h-[380px] md:h-[450px] flex flex-col hover:shadow-purple-500/10 min-h-0 overflow-hidden"
                    >
                    ...
                    <GlassCard
                        className="md:p-8 h-[380px] md:h-[450px] flex flex-col hover:shadow-pink-500/10 min-h-0 overflow-hidden"
                    >
