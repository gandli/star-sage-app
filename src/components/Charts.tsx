...
const Charts: React.FC<ChartsProps> = ({ pieData, languageStats, starTrends, hotTopics, isSyncing }) => {
        ...
        if (active && payload && payload.length) {
            ...
            return (
                ...
                >
                    ...
                    <p className="opacity-60">Projects: {payload[0].value}</p>
                </div>
            );
        }
        return null;
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            ...
            <div className="premium-glass p-6 md:p-8 h-[380px] md:h-[450px] flex flex-col rounded-[2.5rem] hover:shadow-2xl hover:shadow-blue-500/5 transition-all duration-500 min-h-0 overflow-hidden">
            ...
            {/* 2. Star Trends (Area) */}
            <div className="premium-glass p-6 md:p-8 h-[380px] md:h-[450px] flex flex-col rounded-[2.5rem] hover:shadow-2xl hover:shadow-indigo-500/5 transition-all duration-500 min-h-0 overflow-hidden">
            ...
            {/* 3. Ranking (Bar) */}
            <div className="premium-glass p-6 md:p-8 h-[380px] md:h-[450px] flex flex-col rounded-[2.5rem] hover:shadow-2xl hover:shadow-purple-500/5 transition-all duration-500 min-h-0 overflow-hidden">
            ...
            <div className="premium-glass p-6 md:p-8 h-[380px] md:h-[450px] flex flex-col rounded-[2.5rem] hover:shadow-2xl hover:shadow-pink-500/5 transition-all duration-500 min-h-0 overflow-hidden">
