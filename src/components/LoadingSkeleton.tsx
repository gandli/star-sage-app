...
const SkeletonCard: React.FC<{ index: number }> = ({ index }) => {
    return (
        <motion.div
            ...
            // Matched to RepoCard: p-3.5, rounded-[1.25rem], h-[220px]
            className="relative flex flex-col p-3.5 rounded-[1.25rem] premium-glass border-[var(--border-glass)] bg-[var(--bg-glass)] h-[220px] overflow-hidden"
        >
            ...
            <div className="relative z-10 flex-1 flex flex-col space-y-3">
                ...
                {/* Description skeleton - adjusted to fill available space like real card */}
                <div className="flex flex-col gap-2 flex-grow">
                    ...
                    <div className="h-3 w-4/6 bg-gradient-to-br from-zinc-200 to-zinc-300 dark:from-zinc-700 dark:to-zinc-800 rounded animate-pulse" />
                </div>

                {/* Topics skeleton - match real card placement */}
                ...
                {/* Footer skeleton */}
                <div className="mt-auto pt-2.5 border-t border-[var(--border-main)] flex items-center justify-between h-9">
