...
const RepoCard: React.FC<RepoCardProps> = ({ repo, index, token }) => {
    ...
    return (
        <motion.div
            ...
            className="group relative flex flex-col p-4 rounded-[1.75rem] premium-glass transition-all duration-500 hover:-translate-y-3 hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.2)] dark:hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.4)] content-visibility-auto overflow-hidden border-[var(--border-glass)] bg-[var(--bg-glass)] h-[260px]"
        >
            <div className="absolute inset-0 rounded-[1.75rem] ring-1 ring-transparent transition-all duration-500" />
            ...
            <div className="relative z-10 flex-1 flex flex-col">
                ...
                >
                    <h3 className="font-bold text-xl line-clamp-1 group-hover:scale-[1.02] origin-left transition-all duration-300 uppercase">
                        {repo.name}
                    </h3>
                </a>
                ...
                <div className="mt-auto pt-3 border-t border-[var(--border-main)] group-hover:border-blue-500/20 transition-colors duration-300 flex items-center justify-between h-10">
                    <div className="flex items-center gap-4">
                        {repo.language && (
                            <div className="flex items-center gap-2 group/lang">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-widest opacity-60 group-hover/lang:opacity-100 transition-all font-inter">{repo.language}</span>
                            </div>
                        )}
                        <div className="flex items-center gap-1.5 group/stats">
                            <Star size={11} className="text-yellow-500 fill-yellow-500 group-hover/stats:scale-125 transition-all" />
                            <span className="text-[10px] font-black tabular-nums opacity-60 group-hover/stats:opacity-100 transition-all font-inter">{(repo.stargazers_count || 0).toLocaleString()}</span>
                        </div>
                    </div>
