...
const Sidebar: React.FC<SidebarProps> = ({
    ...
    return (
        <aside
            className={`border-r border-[var(--border-main)] flex flex-col flex-shrink-0 z-20 backdrop-blur-2xl transition-all duration-500 relative bg-[var(--bg-sidebar)] ${collapsed ? 'w-20' : 'w-64'}`}
        >
