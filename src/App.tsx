...
import { useRepoStats } from './hooks/useRepoStats'; // Missing import
...
const App: React.FC = () => {
  ...
  const { repos, loading, syncProgress, error, setError, fetchAllStars } = useGithubSync(config, session?.provider_token || undefined);
