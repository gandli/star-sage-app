...
## 2024-05-23 - [Missing Form Labels]
**Learning:** Several input fields (e.g., in SettingsModal, AuthScreen) lack programmatically associated labels, relying on placeholders or visual-only text. This prevents screen readers from announcing the input's purpose.
**Action:** Always use 'htmlFor' on labels and matching 'id' on inputs. For inputs without visible labels, use 'aria-label'.
